...
public class RegisterActivity extends BaseActivity {
        ...
        apiService.registerUser(authRequest).enqueue(new Callback<AuthResponse>() {
            ...
            public void onResponse(Call<AuthResponse> call, Response<AuthResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    saveUserToProfiles(userId, name, email);
                } else {
    ...
    private void saveUserToProfiles(String userId, String name, String email) {
        User user = new User();
        ...
        apiService.saveUserToDatabase(user, "return=minimal").enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                ...
                handleSuccessfulRegistration(name, email, userId);
            }
    ...
    private void handleSuccessfulRegistration(String name, String email, String userId) {
        appPrefs.edit()
